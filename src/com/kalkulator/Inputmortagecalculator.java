...
public class Inputmortagecalculator {
    ...
    public float inputRate() {
        ...
        while (!scaner.hasNextFloat()&&scaner.nextFloat()<(float)positive) scaner.next();//petla aby tylko skaner przyjmowal float  i wieksza niz zero(ale to cos nie działą)
